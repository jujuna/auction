    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=30, unique=True, verbose_name='მეტსახელი')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='მეილი')),
                ('phone', models.CharField(max_length=30, verbose_name='ტელეფონის ნომერი')),
                ('balance', models.IntegerField(default=0, verbose_name='ბალანსი')),
                ...
                ('passport_id', models.IntegerField(verbose_name='პირადი ნომერი')),
